...
export declare class PblNgridDetailRowDefDirective extends PblNgridSingleTemplateRegistry<PblNgridDetailRowContext, 'detailRow'> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PblNgridDetailRowDefDirective, "[pblNgridDetailRowDef]", never, { "hasAnimation": "pblNgridDetailRowDefHasAnimation"; }, {}, never, never, false>;
}
export declare class PblNgridDetailRowParentRefDirective<T> extends PblNgridRowDef<T> implements OnInit, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PblNgridDetailRowParentRefDirective<any>, "[pblNgridDetailRowParentRef]", never, { "columns": "pblNgridDetailRowParentRef"; "when": "pblNgridDetailRowParentRefWhen"; }, {}, never, never, false>;
}
