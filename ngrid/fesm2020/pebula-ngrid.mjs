    ...
    if (rowDef === columnStore.headerColumnDef) {
      if (metaRow.gridWidthRow === true) {
        ...
        this.addToSection(
          this.header,
          metaRow,
          columnStore.metaHeaderRows.length
        );
      }
...
/** @nocollapse */ PblNgridMetaRowService.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridMetaRowService,
  deps: [{ token: EXT_API_TOKEN }],
  target: i0.ɵɵFactoryTarget.Injectable,
});
/** @nocollapse */ PblNgridMetaRowService.ɵprov = i0.ɵɵngDeclareInjectable({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridMetaRowService,
  ...
  ngOnChanges(changes) {
    if ('type' in changes) {
      ...
      scrollContainerElement.scrollLeft =
        this.metaRows.extApi.grid.viewport.measureScrollOffset('start') *
        this._hzScrollDir;
      if (changes.type.isFirstChange) {
        this.metaRows.hzScroll
          ...
          .subscribe(
            (offset) =>
              (scrollContainerElement.scrollLeft = offset * this._hzScrollDir)
          );
...
/** @nocollapse */ PblNgridMetaRowContainerComponent.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblNgridMetaRowContainerComponent,
    deps: [{ token: PblNgridMetaRowService }, { token: i0.ElementRef }],
    target: i0.ɵɵFactoryTarget.Component,
  });
/** @nocollapse */ PblNgridMetaRowContainerComponent.ɵcmp =
  i0.ɵɵngDeclareComponent({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridMetaRowContainerComponent,
    selector: 'div[pbl-ngrid-fixed-meta-row-container]',
    inputs: { type: ['pbl-ngrid-fixed-meta-row-container', 'type'] },
    host: {
      properties: { 'style.width.px': '_innerWidth' },
      styleAttribute: 'flex: 0 0 auto; overflow: hidden;',
    },
    usesOnChanges: true,
    ngImport: i0,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: PblNgridMetaRowService }, { type: i0.ElementRef }];
  },
  propDecorators: {
    type: [
      {
...
function isPblMetaColumn(def) {
  return (
    def instanceof PblMetaColumn ||
    (def && def[PBL_NGRID_META_COLUMN_MARK] === true)
  );
}
class PblMetaColumn {
  constructor(def) {
    ...
    if (value !== this._width) {
      ...
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        if (!this._parsedWidth && value) {
          throw new Error(
            `Invalid width "${value}" in column ${this.id}. Valid values are ##% or ##px (50% / 50px)`
          );
        }
      }
      const isFixedWidth = this._parsedWidth && this._parsedWidth.type === 'px';
      Object.defineProperty(this, 'isFixedWidth', {
        value: isFixedWidth,
        configurable: true,
      });
    }
...
function isPblColumnGroup(def) {
  return (
    def instanceof PblColumnGroup ||
    (def && def[PBL_NGRID_COLUMN_GROUP_MARK] === true)
  );
}
...
class PblColumnGroup extends PblMetaColumn {
  constructor(def, columns, placeholder = false) {
    super(
      isPblColumnGroup(def)
        ? def
        : {
            id: `group-${def.columnIds.join('.')}-row-${def.rowIndex}`,
            kind: 'header',
            ...def,
          }
    );
  ...
  createSlave(columns = []) {
    const slave = new PblColumnGroup(
      { ...this, id: this.id + '-slave' + Date.now() },
      columns
    );
    slave.slaveOf = this;
    Object.defineProperty(slave, 'template', {
      get: function () {
        return this.slaveOf.template;
      },
      set: function (value) {},
    });
    return slave;
...
function isPblColumn(def) {
  return (
    def instanceof PblColumn || (def && def[PBL_NGRID_COLUMN_MARK] === true)
  );
}
class PblColumn {
  ...
  set width(value) {
    if (value !== this._width) {
      ...
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        if (!this._parsedWidth && value) {
          throw new Error(
            `Invalid width "${value}" in column ${this.prop}. Valid values are ##% or ##px (50% / 50px)`
          );
        }
      }
  ...
  groupLogic(columnGroups, groupExists) {
    ...
    if (groupExists) {
      ...
      if (gCurr.placeholder) {
        ...
        const groupWithPlaceholder = prevPH
          ? gPrev
          : nextPH
          ? gNext
          : undefined;
...
class PblColumnFactory {
  ...
  get currentHeaderRow() {
    return this._currentHeaderRow;
  }
  get currentFooterRow() {
    return this._currentFooterRow;
  }
  ...
  build() {
    ...
    const table = {
      ...
      cols: _raw.table.cols.map(
        (d) => new PblColumn({ ..._defaults.table, ...d }, groupStore)
      ),
    };
  ...
  genRowClass(rowOptions, fallbackRowIndex) {
    return (
      (rowOptions && rowOptions.rowClassName) ||
      `pbl-ngrid-row-index-${fallbackRowIndex.toString()}`
    );
  }
  buildHeaderGroups(rowIndex, headerGroupDefs, table) {
    ...
    for (const d of defs) {
      ...
      if (d.prop) {
        if (typeof ngDevMode === 'undefined' || ngDevMode) {
          deprecatedWarning(
            'PblColumnGroupDefinition.prop',
            '4',
            'PblColumnGroupDefinition.columnIds'
          );
          deprecatedWarning(
            'PblColumnGroupDefinition.span',
            '4',
            'PblColumnGroupDefinition.columnIds'
          );
        }
        const start = tableDefs.findIndex((c) => c.orgProp === d.prop);
        d.columnIds = tableDefs
          .slice(start, start + d.span + 1)
          .map((c) => c.id);
        delete d.prop;
        delete d.span;
      }
      d.rowIndex = rowIndex;
      const group = new PblColumnGroup(
        d,
        tableDefs.filter((c) => d.columnIds.indexOf(c.orgProp) > -1),
        false
      );
    ...
    while (tableDefs.length) {
      ...
      const existingGroupIndex = headerGroup.findIndex(
        (hg) => hg.columnIds.indexOf(orgProp) > -1
      );
      if (existingGroupIndex > -1) {
        ...
        if (prev?.placeholder) {
          ...
          delete clone.id;
          headerGroup[marker - 1] = new PblColumnGroup(
            clone,
            [...prev.columns, column],
            true
          );
...
const DYNAMIC_PADDING_BOX_MODEL_SPACE_STRATEGY = {
  ...
  group(cols, dir) {
    ...
    return len > 0
      ? parseInt(
          cols[0].style[dir === 'rtl' ? 'paddingRight' : 'paddingLeft'],
          10
        ) +
          parseInt(
            cols[len - 1].style[dir === 'rtl' ? 'paddingLeft' : 'paddingRight'],
            10
          )
      : 0;
  },
...
class PblNgridColumnDef extends CdkColumnDef {
  ...
  updateWidth(width, reason) {
    ...
    const maxWidth = isFixedWidth
      ? Math.min(
          this._column.parsedWidth.value,
          this._column.maxWidth || this._column.parsedWidth.value
        )
      : this._column.maxWidth;
    const newWidths = [
      minWidth || '',
      width,
      maxWidth ? `${maxWidth}px` : width,
    ];
    if (reason === 'resize') {
   ...
   */
  applySourceWidth(element) {
    setWidth(element, this._widths[0]);
  }
  /**
  ...
  queryCellElements(...filter) {
    ...
    if (filter.length === 0) {
      ...
      for (const f of filter) {
        switch (f) {
          ...
          case 'header':
            query.push(
              `.pbl-ngrid-header-cell${cssId}:not(.pbl-header-group-cell)`
            );
            break;
          case 'headerGroup':
          ...
          case 'footer':
            query.push(
              `.pbl-ngrid-footer-cell${cssId}:not(.pbl-footer-group-cell)`
            );
            break;
          case 'footerGroup':
    ...
    return query.length === 0
      ? []
      : Array.from(this.extApi.element.querySelectorAll(query.join(', ')));
  }
  /** @internal */
  ngOnDestroy() {
    this.detach();
...
/** @nocollapse */ PblNgridColumnDef.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
...
/** @nocollapse */ PblNgridColumnDef.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridColumnDef,
  selector: '[pblNgridColumnDef]',
  inputs: { column: ['pblNgridColumnDef', 'column'] },
  outputs: { widthChange: 'pblNgridColumnDefWidthChange' },
  providers: [
    ...
    if (width) {
      switch (width.type) {
        ...
        default:
          if (typeof ngDevMode === 'undefined' || ngDevMode) {
            throw new Error(
              `Invalid width "${column.width}" in column ${column.prop}. Valid values are ##% or ##px (50% / 50px)`
            );
          }
          return;
      }
...
class MetaRowsStore {
  ...
  updateHeader(value) {
    this.setHeader(
      Object.assign(this.headers[value.rowDef.rowIndex] || {}, value)
    );
  }
  updateFooter(value) {
    this.setFooter(
      Object.assign(this.footers[value.rowDef.rowIndex] || {}, value)
    );
  }
  clear() {
    this.headers = [];
...
class ColumnApi {
  ...
  get visibleColumnIds() {
    return this.store.visibleColumnIds;
  }
  get hiddenColumnIds() {
    return this.store.hiddenColumnIds;
  }
  get visibleColumns() {
    return this.store.visibleColumns;
  }
  get columns() {
    return this.store.allColumns;
  }
  get columnIds() {
    return this.store.columnIds;
  }
  get totalColumnWidthChange() {
    if (!this._totalColumnWidthChange) {
      this._totalColumnWidthChange = this.extApi.events.pipe(
        ON_RESIZE_ROW,
        // We might get a null sizeInfo when a new column is added - see syncColumnGroupsSize()
        map((e) =>
          this.grid.columnApi.visibleColumns.reduce(
  ...
  showColumns(columnOrShowAll, ...columns) {
    if (columnOrShowAll === true) {
      ...
      this.store.updateColumnVisibility(undefined, [
        columnOrShowAll,
        ...columns,
      ]);
    }
  ...
  autoSizeToFit(totalWidth, options = {}) {
    ...
    for (let i = 0; i < visibleColumns.length; i++) {
      ...
      if (forceWidthType === 'px' || (!forceWidthType && column.isFixedWidth)) {
        // (1)
        width = `${totalWidth * r}px`;
      } else if (forceWidthType === '%' || (!forceWidthType && column.width)) {
        // (2)
        width = `${100 * r}%`;
  ...
  addGroupBy(...column) {
    this.store.addGroupBy(...column);
  }
  removeGroupBy(...column) {
    this.store.removeGroupBy(...column);
  }
  findColumnAutoSize(column) {
    const { columnDef } = column;
    const cells = columnDef.queryCellElements();
    for (let i = 0, len = cells.length; i < len; i++) {
      const parentRow = this.extApi.rowsApi.findRowByElement(
        cells[i].parentElement
      );
...
class PblRowsApi {
  constructor(extApi, zone, cellFactory) {
    ...
    this.metaRowService.sync.pipe(unrx(this)).subscribe(() => {
      this.firstLast.header = updateMetaRowFirstLastClass(
        'header',
        this.extApi.element,
        this.firstLast.header
      );
      this.firstLast.footer = updateMetaRowFirstLastClass(
        'footer',
        this.extApi.element,
        this.firstLast.footer
      );
    });
    extApi.columnStore
      .columnRowChange()
      ...
      .subscribe((event) => {
        ...
        event.changes.forEachOperation(
          (record, previousIndex, currentIndex) => {
            if (record.previousIndex == null) {
              ...
              if (!requireSizeUpdate && gridWidthRow) {
                ...
                requireSizeUpdate =
                  currentIndex === lastIndex || previousIndex === lastIndex;
              }
            }
          }
        );
    ...
    extApi.onConstructed(() => {
      ...
      if (this.intersection.observerMode) {
        this.intersection.intersectionChanged.subscribe((entries) => {
        ...
        extApi.viewport.scrolling.subscribe((scrolling) => {
    ...
    extApi.events.pipe(ON_INVALIDATE_HEADERS).subscribe((event) => {
  ...
  findColumnRow(type) {
    return Array.from(this.rows.get(type)).find(
      (r) => r.gridWidthRow === false
    );
  }
...
class PblNgridPluginController {
  ...
  static onCreatedSafe(token, fn) {
    if (!REGISTERED_TO_CREATE.has(token)) {
      ...
      PblNgridPluginController.created.subscribe((event) =>
        fn(event.table, event.controller)
      );
    }
  }
  static find(grid) {
   ...
   */
  onInit() {
    return this.grid.isInit
      ? of(false)
      : this.events.pipe(ON_INIT, mapTo(true));
  }
  hasPlugin(name) {
  ...
  createPlugin(name) {
    ...
    if (!methodName) {
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        throw new Error(
          `Invalid plugin configuration for ${name}, no factory metadata.`
        );
      }
      return;
      ...
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        throw new Error(
          `Invalid plugin configuration for ${name}, factory metadata does not point to a function.`
        );
      }
      return;
    }
...
class PblNgridBaseRowComponent {
  ...
  ngOnInit() {
    if (!this.grid) {
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        throw new Error(
          `When a grid row is used outside the scope of a grid, you must provide the grid instance.`
        );
      }
    }
    this.resolveTokens();
    ...
    if (cmp) {
      if (!this.canMoveCell || this.canMoveCell(fromIndex, toIndex, cmp)) {
        ...
        moveItemInArrayExt(
          ...
          fromIndex,
          toIndex,
          (previousItem, currentItem, previousIndex, currentIndex) => {
            if (this.cellMoved) {
              this.cellMoved(
                previousItem,
                currentItem,
  ...
  createComponent(column, atIndex) {
    ...
    const cell = this._viewRef.createComponent(
      this._extApi.rowsApi.cellFactory.getComponentFactory(this),
      atIndex,
      this.cellInjector
    );
...
/** @nocollapse */ PblNgridBaseRowComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridBaseRowComponent,
  deps: [
    { token: PBL_NGRID_COMPONENT, optional: true },
    { token: i0.ChangeDetectorRef },
    { token: i0.ElementRef },
  ],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridBaseRowComponent.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridBaseRowComponent,
  viewQueries: [
    {
      propertyName: '_viewRef',
      first: true,
      predicate: ['viewRef'],
      descendants: true,
...
class RowToRepeaterBridge {
  ...
  bridgeContext(itemArgs, createView) {
    ...
    if (view.rootNodes[0] !== currentRow.element) {
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        throw new Error(
          `Invalid view state, current row element is not the current rendered element!`
        );
      }
    }
...
class PblNgridRowComponent extends PblNgridBaseRowComponent {
  ...
  updateRow() {
    if (this.currRow !== this.context.$implicit) {
      ...
      if (this.currRow) {
        if (
          this.grid.rowClassUpdate &&
          this.grid.rowClassUpdateFreq === 'item'
        ) {
  ...
  detectChanges() {
    if (
      this.grid.rowClassUpdate &&
      this.grid.rowClassUpdateFreq === 'ngDoCheck'
    ) {
      this.updateHostClass();
    }
  ...
  updateHostClass() {
    ...
    if (this.grid.rowClassUpdate) {
      if (!this._classDiffer) {
        this._classDiffer = new StylingDiffer(
          'NgClass',
          1 /* StylingDifferOptions.TrimProperties */ |
            2 /* StylingDifferOptions.AllowSubKeys */ |
            4 /* StylingDifferOptions.AllowStringValue */ |
            16 /* StylingDifferOptions.ForceAsMap */
        );
  ...
  cellMoved(previousItem, currentItem, previousIndex, currentIndex) {
    ...
    this.context.updateCell(
      previousItem.instance.cellCtx.clone(currentItem.instance.column)
    );
...
/** @nocollapse */ PblNgridRowComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridRowComponent,
  deps: null,
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblNgridRowComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridRowComponent,
  ...
  host: {
    attributes: { role: 'row' },
    classAttribute: 'cdk-row pbl-ngrid-row',
  },
  providers: [{ provide: CdkRow, useExisting: PblNgridRowComponent }],
  viewQueries: [
    {
      propertyName: '_viewRef',
      first: true,
...
class PblNgridColumnRowComponent extends PblNgridBaseRowComponent {
  ...
  handleVisibility() {
    ...
    this._extApi.propChanged.pipe(unrx(this)).subscribe((event) => {
...
/** @nocollapse */ PblNgridColumnRowComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridColumnRowComponent,
  deps: [
    { token: PBL_NGRID_COMPONENT, optional: true },
    { token: i0.ChangeDetectorRef },
    { token: i0.ElementRef },
    { token: PblNgridMetaRowService },
    { token: 'footer', attribute: true },
    { token: 'gridWidthRow', attribute: true },
  ],
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblNgridColumnRowComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridColumnRowComponent,
  selector: 'pbl-ngrid-column-row',
  inputs: { row: 'row' },
  host: { attributes: { role: 'row' } },
  providers: [
...
/** @nocollapse */ PblNgridMetaRowComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridMetaRowComponent,
  deps: [
    { token: PBL_NGRID_COMPONENT, optional: true },
    { token: i0.ChangeDetectorRef },
    { token: i0.ElementRef },
...
/** @nocollapse */ PblNgridMetaRowComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridMetaRowComponent,
...
/** @nocollapse */ PblNgridCellFactoryResolver.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridCellFactoryResolver,
  deps: [{ token: NGRID_CELL_FACTORY }],
  target: i0.ɵɵFactoryTarget.Injectable,
});
/** @nocollapse */ PblNgridCellFactoryResolver.ɵprov = i0.ɵɵngDeclareInjectable(
  {
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
...
class PblNgridRegistryService {
  ...
  getSingle(kind) {
    return (
      this._singles[kind] || (this._parent && this._parent.getSingle(kind))
    );
  }
  ...
  getMultiDefault(kind) {
    return (
      this._multiDefaults[kind] ||
      (this._parent && this._parent.getMultiDefault(kind))
    );
  }
...
/** @nocollapse */ PblNgridRegistryService.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridRegistryService,
  deps: [{ token: PblNgridRegistryService, optional: true, skipSelf: true }],
  target: i0.ɵɵFactoryTarget.Injectable,
});
/** @nocollapse */ PblNgridRegistryService.ɵprov = i0.ɵɵngDeclareInjectable({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridRegistryService,
...
/** @nocollapse */ PblNgridRowDef.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridRowDef,
  deps: [
    ...
    { token: PblNgridRegistryService },
    { token: CDK_TABLE, optional: true },
  ],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridRowDef.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridRowDef,
  selector: '[pblNgridRowDef]',
  inputs: {
    columns: ['pblNgridRowDefColumns', 'columns'],
    when: ['pblNgridRowDefWhen', 'when'],
  },
  providers: [{ provide: CdkRowDef, useExisting: PblNgridRowDef }],
  usesInheritance: true,
  ngImport: i0,
});
i0.ɵɵngDeclareClassMetadata({
      ...
      args: [
        {
          selector: '[pblNgridRowDef]',
          inputs: [
            'columns: pblNgridRowDefColumns',
            'when: pblNgridRowDefWhen',
          ],
          providers: [{ provide: CdkRowDef, useExisting: PblNgridRowDef }],
        },
      ],
...
/** @nocollapse */ PblNgridRowOverride.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridRowOverride,
  deps: [
    { token: i0.TemplateRef },
    { token: i0.IterableDiffers },
    { token: PblNgridRegistryService },
...
/** @nocollapse */ PblNgridRowOverride.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridRowOverride,
...
class PblCellContext {
  ...
  get row() {
    return this.rowContext.$implicit;
  }
  get value() {
  ...
  clone(col) {
    const ctx = PblCellContext.create(
      this._rowContext,
      col || this.col,
      this.extApi
    );
...
class PblRowContext {
  ...
  cell(index) {
    const idx =
      typeof index === 'number' ? index : this.grid.columnApi.indexOf(index);
  ...
  _rebuildCells(columns) {
    ...
    for (let columnIndex = 0; columnIndex < len; columnIndex++) {
      const cellContext = PblCellContext.create(
        this,
        columns[columnIndex],
        this.extApi
      );
  ...
  updateRowData() {
    if (this._attachedRow) {
      ...
      this.extApi.contextApi._updateRowContext(
        this,
        this._attachedRow.rowIndex
      );
...
function findRowRenderedIndex(el) {
  const rows = Array.from(
    closest(el, 'pbl-cdk-table').querySelectorAll('pbl-ngrid-row')
  );
...
function resolveCellReference(cellRef, context) {
  ...
  if (rowState) {
    const rowContext = context.extApi.grid.contextApi.findRowInView(
      rowState.identity
    );
    if (rowContext) {
...
class ContextApi {
  constructor(extApi) {
    ...
    this.cache = new Map();
    this.activeSelected = [];
    this.focusChanged$ = new BehaviorSubject({
      prev: undefined,
      curr: undefined,
    });
     ...
     */
    this.focusChanged = this.focusChanged$.pipe(
      buffer(this.focusChanged$.pipe(debounceTime(0, asapScheduler))),
      map((events) => ({
        prev: events[0]?.prev,
  ...
  _createRowContext(data, renderRowIndex) {
    const context = new PblRowContext(
      data,
...
/** @nocollapse */ PblNgridMultiTemplateRegistry.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridMultiTemplateRegistry,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridMultiTemplateRegistry.ɵdir = i0.ɵɵngDeclareDirective(
  {
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridMultiTemplateRegistry,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: i0.TemplateRef }, { type: PblNgridRegistryService }];
  },
});
...
class PblNgridHeaderExtensionRefDirective extends PblNgridMultiTemplateRegistry {
  constructor(tRef, registry) {
    super(tRef, registry);
    this.name =
      'genericHeaderExtension-' + PblNgridHeaderExtensionRefDirective._id++;
    this.kind = 'dataHeaderExtensions';
  }
}
PblNgridHeaderExtensionRefDirective._id = 0;
/** @nocollapse */ PblNgridHeaderExtensionRefDirective.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblNgridHeaderExtensionRefDirective,
    deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
    target: i0.ɵɵFactoryTarget.Directive,
  });
/** @nocollapse */ PblNgridHeaderExtensionRefDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridHeaderExtensionRefDirective,
    selector: '[pblNgridHeaderExtensionRef]',
    inputs: { shouldRender: ['pblNgridHeaderExtensionRef', 'shouldRender'] },
    usesInheritance: true,
    ngImport: i0,
  });
i0.ɵɵngDeclareClassMetadata({
...
/** @nocollapse */ PblNgridSingleTemplateRegistry.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridSingleTemplateRegistry,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridSingleTemplateRegistry.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridSingleTemplateRegistry,
...
/** @nocollapse */ PblNgridNoDataRefDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridNoDataRefDirective,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridNoDataRefDirective.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridNoDataRefDirective,
  selector: '[pblNgridNoDataRef]',
  usesInheritance: true,
  ngImport: i0,
});
i0.ɵɵngDeclareClassMetadata({
...
/** @nocollapse */ PblNgridPaginatorRefDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridPaginatorRefDirective,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridPaginatorRefDirective.ɵdir = i0.ɵɵngDeclareDirective(
  {
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridPaginatorRefDirective,
    selector: '[pblNgridPaginatorRef]',
    usesInheritance: true,
    ngImport: i0,
  }
);
...
class PblNgridCellStyling {
  ...
  set style(value) {
    if (!this._styleDiffer) {
      this._styleDiffer = new StylingDiffer(
        'NgStyle',
        8 /* StylingDifferOptions.AllowUnits */
      );
    }
...
/** @nocollapse */ PblNgridCellStyling.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridCellStyling,
  deps: [{ token: i0.ElementRef }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridCellStyling.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridCellStyling,
  selector: '[ngridCellStyle], [ngridCellClass]',
  inputs: {
    style: ['ngridCellStyle', 'style'],
    klass: ['ngridCellClass', 'klass'],
  },
  ngImport: i0,
});
i0.ɵɵngDeclareClassMetadata({
...
function initCellHeaderFooter(element, isFooter) {
  element.classList.add(
    ...(isFooter
      ? ['cdk-footer-cell', 'pbl-ngrid-footer-cell']
      : ['cdk-header-cell', 'pbl-ngrid-header-cell'])
  );
}
function applyWidth() {
...
/** @nocollapse */ PblNgridBaseCell.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridBaseCell,
  deps: [{ token: EXT_API_TOKEN }, { token: i0.ElementRef }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridBaseCell.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridBaseCell,
  ngImport: i0,
...
class PblNgridHeaderCellComponent extends PblNgridBaseCell {
  ...
  setColumn(column, gridWidthRow) {
    ...
    if (prev !== column) {
      ...
      predicate = (event) =>
        (!gridWidthRow && event.reason !== 'update') ||
        (gridWidthRow && event.reason !== 'resize');
  ...
  initMainHeaderColumnView(col) {
    this.cellCtx = PblNgridDataHeaderExtensionContext.createDateHeaderCtx(
      this,
      this.vcRef.injector
    );
  ...
  runHeaderExtensions(context, view) {
    ...
    if (!extensions) {
      ...
      this.zone.onStable
        .pipe(first())
        .subscribe(() => lastDataHeaderExtensions.delete(this.grid));
    }
    let { rootNodes } = view;
...
/** @nocollapse */ PblNgridHeaderCellComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridHeaderCellComponent,
  deps: [
    { token: EXT_API_TOKEN },
    { token: i0.ElementRef },
    { token: i0.NgZone },
...
/** @nocollapse */ PblNgridHeaderCellComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridHeaderCellComponent,
  ...
  host: {
    ...
    classAttribute: 'cdk-header-cell pbl-ngrid-header-cell',
  },
  viewQueries: [
    {
      propertyName: 'vcRef',
...
class PblNgridCellComponent extends PblNgridBaseCell {
  ...
  ngDoCheck() {
    if (this._rowCtx) {
      ...
      this.template = cellContext.editing
        ? this.column.editorTpl
        : this.column.cellTpl;
...
/** @nocollapse */ PblNgridCellComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridCellComponent,
  deps: null,
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblNgridCellComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridCellComponent,
...
/** @nocollapse */ PblNgridFooterCellComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridFooterCellComponent,
  deps: null,
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblNgridFooterCellComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridFooterCellComponent,
  ...
  host: {
    attributes: { role: 'gridcell' },
    classAttribute: 'cdk-footer-cell pbl-ngrid-footer-cell',
  },
  usesInheritance: true,
  ngImport: i0,
...
/** @nocollapse */ PblNgridMetaCellComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridMetaCellComponent,
  deps: null,
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblNgridMetaCellComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridMetaCellComponent,
  selector: 'pbl-ngrid-meta-cell',
  host: { attributes: { role: 'cell' } },
  viewQueries: [
    {
      propertyName: 'vcRef',
      first: true,
...
/** @nocollapse */ PblNgridBaseCellDef.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridBaseCellDef,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridBaseCellDef.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridBaseCellDef,
  ngImport: i0,
...
/** @nocollapse */ PblNgridHeaderCellDefDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridHeaderCellDefDirective,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridHeaderCellDefDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridHeaderCellDefDirective,
    ...
    inputs: {
      name: ['pblNgridHeaderCellDef', 'name'],
      type: ['pblNgridHeaderCellTypeDef', 'type'],
    },
    usesInheritance: true,
    ngImport: i0,
  });
...
/** @nocollapse */ PblNgridCellDefDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridCellDefDirective,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridCellDefDirective.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridCellDefDirective,
  selector: '[pblNgridCellDef], [pblNgridCellTypeDef]',
  inputs: {
    name: ['pblNgridCellDef', 'name'],
    type: ['pblNgridCellTypeDef', 'type'],
  },
  usesInheritance: true,
  ngImport: i0,
});
...
/** @nocollapse */ PblNgridEditorCellDefDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridEditorCellDefDirective,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridEditorCellDefDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridEditorCellDefDirective,
    ...
    inputs: {
      name: ['pblNgridCellEditorDef', 'name'],
      type: ['pblNgridCellEditorTypeDef', 'type'],
    },
    usesInheritance: true,
    ngImport: i0,
  });
...
/** @nocollapse */ PblNgridFooterCellDefDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridFooterCellDefDirective,
  deps: [{ token: i0.TemplateRef }, { token: PblNgridRegistryService }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridFooterCellDefDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridFooterCellDefDirective,
    ...
    inputs: {
      name: ['pblNgridFooterCellDef', 'name'],
      type: ['pblNgridFooterCellTypeDef', 'type'],
    },
    usesInheritance: true,
    ngImport: i0,
  });
...
/** @nocollapse */ PblNgridCellEditAutoFocusDirective.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblNgridCellEditAutoFocusDirective,
    deps: [{ token: i0.ElementRef }, { token: i0.NgZone }],
    target: i0.ɵɵFactoryTarget.Directive,
  });
/** @nocollapse */ PblNgridCellEditAutoFocusDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridCellEditAutoFocusDirective,
    selector: '[pblCellEditAutoFocus]',
    inputs: { context: ['pblCellEditAutoFocus', 'context'] },
    ngImport: i0,
  });
i0.ɵɵngDeclareClassMetadata({
  minVersion: '12.0.0',
...
class PblNgridBaseRowViewRepeaterStrategy {
  constructor(extApi) {
    ...
    extApi.onConstructed(() => {
      ...
      this.workaroundEnabled =
        !cdkTable['_cachedRenderDefMap'] &&
        typeof this.renderer._renderCellTemplateForItem === 'function';
    });
  }
  applyChanges(
    changes,
    ...
    const createEmbeddedView = (
      record,
      adjustedPreviousIndex,
      currentIndex
    ) => {
      const itemArgs = itemContextFactory(
        record,
        adjustedPreviousIndex,
        currentIndex
      );
      itemArgs.context = this.extApi.contextApi._createRowContext(
        itemArgs.context.$implicit,
        itemArgs.index
      );
      return rowContextBridge.bridgeContext(itemArgs, () =>
        vcRef.createEmbeddedView(
          itemArgs.templateRef,
          itemArgs.context,
          itemArgs.index
        )
      );
    ...
    changes.forEachOperation((record, adjustedPreviousIndex, currentIndex) => {
      ...
      if (record.previousIndex == null) {
        ...
        if (state.op === 1 /* _ViewRepeaterOperation.INSERTED */) {
        }
      } else if (currentIndex == null) {
  ...
  patch20765(changes, baseState) {
    changes.forEachIdentityChange = (fn) => {
      changes.constructor.prototype.forEachIdentityChange.call(
        changes,
        (record) => {
          fn(record);
          if (
            this._cachedRenderDefMap.get(record.currentIndex) !==
            record.item.rowDef
          ) {
  ...
  patch20765afterOp(state) {
    switch (state.op) {
      case 0 /* _ViewRepeaterOperation.REPLACED */:
      case 1 /* _ViewRepeaterOperation.INSERTED */:
      case 2 /* _ViewRepeaterOperation.MOVED */:
        this._cachedRenderDefMap.set(
          state.record.currentIndex,
          state.record.item.rowDef
        );
        break;
      case 3 /* _ViewRepeaterOperation.REMOVED */:
        this._cachedRenderDefMap.delete(state.record.previousIndex);
        break;
    }
  }
}
/** @nocollapse */ PblNgridBaseRowViewRepeaterStrategy.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblNgridBaseRowViewRepeaterStrategy,
    deps: [{ token: EXT_API_TOKEN }],
    target: i0.ɵɵFactoryTarget.Injectable,
  });
/** @nocollapse */ PblNgridBaseRowViewRepeaterStrategy.ɵprov =
...
class PblNgridCachedRowViewRepeaterStrategy extends PblNgridBaseRowViewRepeaterStrategy {
  ...
  addItem(adjustedPreviousIndex, currentIndex, state) {
    ...
    if (state.view) {
      ...
      state.op = 0 /* _ViewRepeaterOperation.REPLACED */;
    } else {
      state.view = state.createEmbeddedView(
        state.record,
        adjustedPreviousIndex,
        currentIndex
      );
      state.op = 1 /* _ViewRepeaterOperation.INSERTED */;
    }
  }
  removeItem(removeAt, state) {
    ...
    state.op = 3 /* _ViewRepeaterOperation.REMOVED */;
  }
  moveItem(moveFrom, moveTo, state) {
    state.view = state.vcRef.get(moveFrom);
    state.vcRef.move(state.view, moveTo);
    state.view.context.$implicit = state.itemValueResolver(state.record);
    state.op = 2 /* _ViewRepeaterOperation.MOVED */;
  }
  /**
...
/** @nocollapse */ PblNgridCachedRowViewRepeaterStrategy.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblNgridCachedRowViewRepeaterStrategy,
    deps: null,
    target: i0.ɵɵFactoryTarget.Injectable,
  });
/** @nocollapse */ PblNgridCachedRowViewRepeaterStrategy.ɵprov =
  i0.ɵɵngDeclareInjectable({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
...
class PblCdkTableComponent extends CdkTable {
  ...
  ngOnInit() {
    ...
    this.pblStickyStyler = new StickyStyler(
    ...
    (this._dir?.change ?? of()).pipe(unrx(this)).subscribe((value) => {
  ...
  _updateStickyColumnStyles() {
    ...
    const stickyStartStates = this.extApi.columnApi.visibleColumns.map(
      (c) => c.columnDef?.sticky ?? false
    );
    const stickyEndStates = this.extApi.columnApi.visibleColumns.map(
      (c) => c.columnDef?.stickyEnd ?? false
    );
    ...
    this.pblStickyStyler.updateStickyColumns(
      rows,
      stickyStartStates,
      stickyEndStates,
      true
    ...
    this.extApi.columnApi.columns.forEach((c) =>
      c.columnDef?.resetStickyChanged()
    );
  }
}
/** @nocollapse */ PblCdkTableComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblCdkTableComponent,
  deps: [
    { token: i0.IterableDiffers },
    { token: i0.ChangeDetectorRef },
    { token: i0.ElementRef },
    { token: 'role', attribute: true },
    { token: i1$1.Directionality, optional: true },
    { token: i0.Injector },
    { token: PBL_NGRID_COMPONENT },
    { token: EXT_API_TOKEN },
    { token: DOCUMENT },
    { token: i2.Platform },
    { token: _VIEW_REPEATER_STRATEGY },
    { token: _COALESCED_STYLE_SCHEDULER },
    { token: i3.ViewportRuler },
    { token: STICKY_POSITIONING_LISTENER, optional: true, skipSelf: true },
  ],
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblCdkTableComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblCdkTableComponent,
  selector: 'pbl-cdk-table',
  host: { classAttribute: 'pbl-cdk-table' },
  providers: [
    { provide: CDK_TABLE, useExisting: PblCdkTableComponent },
    {
      provide: _VIEW_REPEATER_STRATEGY,
      useClass: PblNgridCachedRowViewRepeaterStrategy,
    },
  ...
  isInline: true,
  dependencies: [
    { kind: 'directive', type: i4.DataRowOutlet, selector: '[rowOutlet]' },
    {
      kind: 'directive',
      type: i4.HeaderRowOutlet,
      selector: '[headerRowOutlet]',
    },
    {
      kind: 'directive',
      type: i4.FooterRowOutlet,
      selector: '[footerRowOutlet]',
    },
    {
      kind: 'directive',
      type: i4.NoDataRowOutlet,
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [
      ...
      {
        type: i4._CoalescedStyleScheduler,
        decorators: [
          {
            type: Inject,
...
class PblNgridColumnWidthCalc {
  constructor(extApi) {
    ...
    this.dynamicColumnWidth = new DynamicColumnWidthLogic(
  ...
  resetColumnsWidth() {
    resetColumnWidths(
      this.columnStore.getStaticWidth(),
      this.columnStore.visibleColumns,
      this.columnStore.metaColumns
    );
  }
  ...
  syncColumnGroupsSize() {
    ...
    for (const g of this.columnStore.getAllHeaderGroup()) {
      ...
      const colSizeInfos = this.columnStore.visibleColumns
        .filter((c) => !c.hidden && c.isInGroup(g))
        .map((c) => c.sizeInfo)
        .filter((c) => !!c);
  ...
  listenToResize() {
    ...
    ro$
      ...
      .subscribe((args) => {
        if (skipValue === 0) {
          skipValue = 1;
          this.extApi.columnStore.visibleColumns.forEach((c) =>
            c.sizeInfo.updateSize()
          );
        }
...
function noDataViewLogicap(extApi) {
  ...
  const logicap = (force) => {
    ...
    if (noData || force === true) {
      ...
      if (noDataTemplate) {
        noDateEmbeddedVRef = extApi.grid.createView(
          'beforeContent',
          noDataTemplate.tRef,
          { $implicit: extApi.grid },
          0
        );
...
function bindRegistryLogicap(extApi) {
  return () => {
    ...
    extApi.registry.changes.subscribe((changes) => {
      let gridCell = false;
    ...
    if (extApi.grid.isInit) {
      ...
      if (usePagination) {
        ...
        if (paginatorTemplate) {
          paginatorEmbeddedVRef = extApi.grid.createView(
            'beforeContent',
            paginatorTemplate.tRef,
            { $implicit: extApi.grid }
          );
        }
      }
...
class InternalExtensionApi {
  constructor(grid, tokens) {
    ...
    this.columnStore = new PblColumnStore(
      this,
      tokens.injector.get(IterableDiffers)
    );
    ...
    this.widthCalc.onWidthCalc.subscribe((rowWidth) => {
  ...
  get contextApi() {
    return this._contextApi || (this._contextApi = new ContextApi(this));
  }
  get viewport() {
...
class PblNgridBaseVirtualScrollDirective {
  ...
  get scrolledIndexChange() {
    return this._scrollStrategy.scrolledIndexChange;
  }
  set scrolledIndexChange(value) {
    this._scrollStrategy.scrolledIndexChange = value;
  }
  attachExtApi(extApi) {
    this._scrollStrategy.attachExtApi(extApi);
  }
  attach(viewport) {
    this._scrollStrategy.attach(viewport);
  }
  detach() {
...
function splitRange(range, headerLen, dataLen) {
  return [
    ...
    {
      start: Math.max(0, range.start - headerLen),
      end: Math.max(0, range.end - headerLen),
    },
...
function measureRangeSize(
  ...
  return firstNode && lastNode
    ? getOffset('end', lastNode) - getOffset('start', firstNode)
    : 0;
}
  ...
  moveHeader(offset, viewPortElRect) {
    if (!this.runningHeader || this.canMoveHeader) {
      ...
      if (stickyAndRendered.length) {
        this.viewport.stickyRowHeaderContainer.style.top =
          mostTopRect.top + 'px';
        this.cloneAndMoveRow(
          this.viewport.stickyRowHeaderContainer,
          headerRows.rows,
          stickyAndRendered,
          this.movedHeaderRows
        );
  ...
  moveFooter(offset, viewPortElRect) {
    if (!this.runningFooter || this.canMoveFooter) {
      ...
      if (stickyAndRendered.length) {
        ...
        this.cloneAndMoveRow(
          this.viewport.stickyRowFooterContainer,
          footerRows.rows,
          stickyAndRendered,
          this.movedFooterRows
        );
...
class PblVirtualScrollForOf {
  constructor(extApi, ngZone) {
    ...
    extApi.events.pipe(takeUntil(this.destroyed)).subscribe((event) => {
      if (event.kind === 'onDataSource') {
        this.detachView();
    ...
    metaRowService.sync.pipe(takeUntil(this.destroyed)).subscribe(() => {
      const headers = metaRowService.header.row
        .concat(metaRowService.header.sticky)
        .sort(sortByIndex);
      const footers = metaRowService.footer.row
        .concat(metaRowService.footer.sticky)
        .sort(sortByIndex);
  ...
  get headerLength() {
    return this.header.rows.length;
  }
  get rowLength() {
    return this.vcRefs.data.length;
  }
  get footerLength() {
    return this.footer.rows.length;
  }
  get vcRefs() {
    const value = {
  ...
  initWheelControl() {
    ...
    const metaRowStickyScroll = new MetaRowStickyScroll(
      this.viewport,
      viewPort,
    ...
    const updateScrollPosition = () =>
      (scrollPosition =
        ...
        (this.viewport.scrollHeight - this.viewport.getViewportSize()));
    const scrollEnd$ = this.viewport.scrolling.pipe(filter((s) => !s));
    const handler = (event) => {
      if (event.deltaY) {
        if (
          (scrollPosition === 1 && event.deltaY > 0) ||
          (offset === 0 && event.deltaY < 0)
        ) {
          return;
        }
        ...
        if (newOffset !== offset) {
          offset = newOffset;
          if (
            metaRowStickyScroll.canMove() &&
            metaRowStickyScroll.move(
              event.deltaY,
              ...
              default:
                ...
                this.viewport.scrollFrameRate
                  ...
                  .subscribe({
                    ...
                    complete: () => {
                      const lastWheel$ = fromEvent(viewPort, 'wheel').pipe(
                        debounceTime(50),
                        take(1)
                      );
                      race(lastWheel$, timer(51)).subscribe(() => {
                        restore();
                        if (removedEvent) {
                          wheelListen();
                        }
  ...
  attachView(ds) {
    if (ds) {
      this.ds = ds;
      this._renderedRanges = [
        { start: 0, end: 0 },
        this.cdkTable.viewChange.value,
        { start: 0, end: 0 },
      ];
      this.viewport.renderedRangeStream
        .pipe(takeUntil(this.destroyed))
        .subscribe((range) => {
          if (this.headerLength + this.footerLength === 0) {
            // if no row/sticky meta rows, move on...
            this._renderedRanges = [
              { start: 0, end: 0 },
              range,
              { start: 0, end: 0 },
          ...
          this.cdkTable.onRenderRows.pipe(take(1)).subscribe(() => {
            ...
            if (this.headerLength > 0) {
              ...
              let rowIndex = 0;
              for (
                const len = this.header.sticky.length - 1;
                rowIndex < len;
                rowIndex++
              ) {
                // assign rendered state + if not rendered and not sticky, set display to "none"
                htmlRows[rowIndex].style.display =
                  !(renderedRows[rowIndex] = rowIndex >= header.start) &&
                  !stickyRows[rowIndex]
                    ? 'none'
                    : null;
              }
            ...
            if (this.footerLength > 0) {
              ...
              let rowIndex = 0;
              for (
                const len = this.footer.sticky.length;
                rowIndex < len;
                rowIndex++
              ) {
                // assign rendered state + if not rendered and not sticky, set display to "none"
                htmlRows[rowIndex].style.display =
                  !(renderedRows[rowIndex] = rowIndex < footer.end) &&
                  !stickyRows[rowIndex]
                    ? 'none'
                    : null;
              }
      ...
      this.dataStream = ds.onRenderDataChanging.pipe(
        takeUntil(this.destroyed),
        map(({ data }) => {
          const metaRows = (this.metaRows = [
            this.header.rows.length,
            this.footer.rows.length,
          ]);
      ...
      ds.onRenderedDataChanged
        ...
        .subscribe(([prev, curr]) => {
          this.ngZone.onStable
            .pipe(take(1))
            .subscribe(() => this.viewport.onSourceLengthChange(prev, curr));
        });
      ...
      const raf = () => {
        ...
        if (scrolling === -1) {
          ...
          if (measure[1] > bufferWindow) {
            measure[3] += measure[1];
            measure[1] = 0;
            vScrollViewport.scrollFrameRate.emit(
              1000 / (measure[3] / measure[2])
            );
          }
...
class AutoSizeVirtualScrollStrategy {
  ...
  _checkRenderedContentOffset() {
    const viewport = this._viewport;
    this._lastRenderedContentOffset =
      viewport.getOffsetToRenderedContentStart();
  }
  /**
...
class PblNgridAutoSizeVirtualScrollStrategy extends AutoSizeVirtualScrollStrategy {
  constructor(
    minBufferPx,
    maxBufferPx,
    averager = new PblNgridItemSizeAverager()
  ) {
  ...
  attach(viewport) {
    if (!this.extApi) {
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        throw new Error(
          'Invalid use of attach, you must first attach `PblNgridExtensionApi`'
        );
      }
    }
  ...
  constructor(rootElement, forceManual) {
    ...
    if (!forceManual && !!IntersectionObserver) {
      this.intersectionObserver = new IntersectionObserver(
        (entries) => intersectionChanged.next(entries),
        {
          root: rootElement,
          rootMargin: '0px',
          threshold: 0.0,
...
class VirtualScrollHightPaging {
      ...
      if (this.active) {
        ...
        if (Math.abs(delta) > viewportSize) {
          ...
          this.page = Math.floor(
            scrollOffset *
              ((this.totalHeight - viewportSize) /
                (MAX_SCROLL_HEIGHT - viewportSize)) *
              (1 / this.pageHeight)
          );
          ...
          if (
            delta > 0 &&
            scrollOffset + this.offset > (this.page + 1) * this.pageHeight
          ) {
            // LOG(`NEXT ${scrollOffset}`);
            this.page += 1;
            this.offset += this.coff;
            viewport.element.scrollTop = this.prevScrollOffset = Math.floor(
              scrollOffset - this.coff
            );
          ...
          // prev page
            ...
            delta < 0 &&
            scrollOffset + this.offset < this.page * this.pageHeight
          ) {
  ...
  transformTotalContentSize(totalHeight, scrollOffset) {
    ...
    if (totalHeight <= MAX_SCROLL_HEIGHT) {
      ...
      this.coff = Math.floor(
        (totalHeight - MAX_SCROLL_HEIGHT) / (this.pageCount - 1)
      );
      this.prevScrollOffset = scrollOffset;
...
const DISABLE_INTERSECTION_OBSERVABLE = new InjectionToken(
...
class PblCdkVirtualScrollViewportComponent extends CdkVirtualScrollViewport {
  ...
  get wheelMode() {
    return (
      this.pblScrollStrategy.wheelMode || this.wheelModeDefault || 'passive'
    );
  }
  /**
...
/** @nocollapse */ PblCdkVirtualScrollViewportComponent.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblCdkVirtualScrollViewportComponent,
    deps: [
      { token: i0.ElementRef },
      { token: i0.ChangeDetectorRef },
      { token: i0.NgZone },
      { token: i1$2.PblNgridConfigService },
      { token: VIRTUAL_SCROLL_STRATEGY, optional: true },
      { token: i1$1.Directionality, optional: true },
      { token: i3.ScrollDispatcher },
      { token: i3.ViewportRuler },
      { token: EXT_API_TOKEN },
      { token: DISABLE_INTERSECTION_OBSERVABLE, optional: true },
      { token: VIRTUAL_SCROLLABLE, optional: true },
    ],
    target: i0.ɵɵFactoryTarget.Component,
  });
/** @nocollapse */ PblCdkVirtualScrollViewportComponent.ɵcmp =
  i0.ɵɵngDeclareComponent({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblCdkVirtualScrollViewportComponent,
    ...
    inputs: {
      stickyRowHeaderContainer: 'stickyRowHeaderContainer',
      stickyRowFooterContainer: 'stickyRowFooterContainer',
    },
    outputs: { scrolling: 'scrolling', scrollFrameRate: 'scrollFrameRate' },
    host: {
      properties: {
    ...
    viewQueries: [
      {
        propertyName: '_innerBoxHelper',
        first: true,
        predicate: ['innerBoxHelper'],
        descendants: true,
        static: true,
      },
    ],
...
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [
      ...
      { type: i0.ChangeDetectorRef },
      { type: i0.NgZone },
      { type: i1$2.PblNgridConfigService },
      {
        type: undefined,
        decorators: [
          {
...
function internalApiFactory(grid) {
  return grid._extApi;
}
function pluginControllerFactory(grid) {
  return grid._plugin.controller;
}
function metaRowServiceFactory(grid) {
...
/** @nocollapse */ PblNgridComponent.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  ...
  deps: [
    ...
    { token: i1$2.PblNgridConfigService },
    { token: PblNgridRegistryService },
    { token: 'id', attribute: true },
    { token: i1$1.Directionality, optional: true },
  ],
  target: i0.ɵɵFactoryTarget.Component,
});
/** @nocollapse */ PblNgridComponent.ɵcmp = i0.ɵɵngDeclareComponent({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridComponent,
  selector: 'pbl-ngrid',
  inputs: {
    ...
    noCachePaginator: 'noCachePaginator',
    columns: 'columns',
    rowClassUpdate: 'rowClassUpdate',
    rowClassUpdateFreq: 'rowClassUpdateFreq',
    minDataViewHeight: 'minDataViewHeight',
  ...
  viewQueries: [
    {
      propertyName: '_vcRefBeforeTable',
      first: true,
      predicate: ['beforeTable'],
      descendants: true,
      read: ViewContainerRef,
      static: true,
    },
    {
      propertyName: '_vcRefBeforeContent',
      first: true,
      predicate: ['beforeContent'],
      descendants: true,
      read: ViewContainerRef,
      static: true,
    },
    {
      propertyName: '_vcRefAfterContent',
      first: true,
      predicate: ['afterContent'],
      descendants: true,
      read: ViewContainerRef,
      static: true,
    },
    {
      propertyName: '_fbTableCell',
      first: true,
      predicate: ['fbTableCell'],
      descendants: true,
      read: TemplateRef,
      static: true,
    },
    {
      propertyName: '_fbHeaderCell',
      first: true,
      predicate: ['fbHeaderCell'],
      descendants: true,
      read: TemplateRef,
      static: true,
    },
    {
      propertyName: '_fbFooterCell',
      first: true,
      predicate: ['fbFooterCell'],
      descendants: true,
      read: TemplateRef,
      static: true,
    },
    {
      propertyName: '_tableRowDef',
      first: true,
      predicate: CdkRowDef,
      descendants: true,
      static: true,
    ...
    {
      propertyName: '_headerRowDefs',
      predicate: CdkHeaderRowDef,
      descendants: true,
    },
    {
      propertyName: '_footerRowDefs',
  ...
  dependencies: [
    ...
    {
      kind: 'directive',
      type: i4.CdkHeaderRowDef,
      selector: '[cdkHeaderRowDef]',
      inputs: ['cdkHeaderRowDef', 'cdkHeaderRowDefSticky'],
    },
    {
      kind: 'directive',
      type: i4.CdkFooterRowDef,
      selector: '[cdkFooterRowDef]',
      inputs: ['cdkFooterRowDef', 'cdkFooterRowDefSticky'],
    },
    {
      kind: 'component',
      type: PblNgridMetaRowContainerComponent,
      selector: 'div[pbl-ngrid-fixed-meta-row-container]',
      inputs: ['pbl-ngrid-fixed-meta-row-container'],
    },
    {
      kind: 'component',
      type: PblCdkTableComponent,
    ...
    },
    {
      ...
      type: PblNgridRowDef,
      selector: '[pblNgridRowDef]',
      inputs: ['pblNgridRowDefColumns', 'pblNgridRowDefWhen'],
    },
    {
      kind: 'component',
      type: PblNgridRowComponent,
    ...
    },
    {
      ...
      type: PblCdkVirtualScrollViewportComponent,
      selector: 'pbl-cdk-virtual-scroll-viewport',
      inputs: ['stickyRowHeaderContainer', 'stickyRowFooterContainer'],
      outputs: ['scrolling', 'scrollFrameRate'],
    },
  ],
  changeDetection: i0.ChangeDetectionStrategy.OnPush,
  encapsulation: i0.ViewEncapsulation.None,
...
class PblNgridOuterSectionDirective {
  ...
  ngAfterViewInit() {
    this.grid.createView(
      this.position === 'bottom' ? 'beforeContent' : 'beforeTable',
      this.tRef
    );
  }
}
/** @nocollapse */ PblNgridOuterSectionDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridOuterSectionDirective,
  deps: [{ token: PblNgridComponent }, { token: i0.TemplateRef }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridOuterSectionDirective.ɵdir = i0.ɵɵngDeclareDirective(
  {
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblNgridOuterSectionDirective,
    selector: '[pblNgridOuterSection]',
    inputs: { position: ['pblNgridOuterSection', 'position'] },
    ngImport: i0,
  }
);
i0.ɵɵngDeclareClassMetadata({
  ...
  ctorParameters: function () {
    return [{ type: PblNgridComponent }, { type: i0.TemplateRef }];
  },
});
...
class SizeGroup {
  ...
  getSubSize(dsIndexStart, dsIndexEnd, itemSize) {
    ...
    const indexEnd =
      this.maxItems - (this.dsEnd - Math.min(dsIndexEnd, this.dsEnd)) - 1;
    let total = 0;
  ...
  getSizeBefore(dsIndex) {
    ...
    for (const g of this.groups.collection) {
      if (g.dsStart < dsIndex) {
        if (g.dsEnd > dsIndex) {
          total +=
            g.getSizeBefore(dsIndex, itemSize) -
            itemSize * (dsIndex - g.dsStart);
        } else {
          total += g.getRawDiffSize(itemSize);
        }
      } else {
  ...
  getSizeForRange(dsIndexStart, dsIndexEnd) {
    ...
    if (startGroupIndex === endGroupIndex) {
      ...
      if (startGroup) {
        ...
        total +=
          ((startGroupIndex + 1) * groupSize - dsIndexStart + 1) * itemSize;
      }
    ...
    for (let i = groups.length - 1; i > -1; i--) {
      ...
      if (g.dsEnd > dsIndex) {
        if (g.dsStart > dsIndex) {
          ...
          total +=
            g.getSizeAfter(dsIndex, itemSize) - itemSize * (g.dsEnd - dsIndex);
        }
      } else {
        break;
      }
  ...
  findRenderItemAtOffset(offset) {
    ...
    while (true) {
      if (groupStartPos < offset) {
        ...
        groupIndex += 1;
        groupStartPos += this.getSizeForRange(
...
class PblNgridDynamicVirtualScrollStrategy {
  ...
  attachExtApi(extApi) {
    this.extApi = extApi;
    this.extApi.events.subscribe((event) => {
      if (event.kind === 'onDataSource') {
  ...
  onRenderedOffsetChanged() {
    if (this._viewport) {
      this._lastRenderedContentOffset =
        this._viewport.getOffsetToRenderedContentStart();
    }
  }
  /**
   * Scroll to the offset for the given index.
  ...
  onDatasource(curr, prev) {
    ...
    if (curr) {
      curr.onSourceChanging.pipe(unrx(this, curr)).subscribe(() => {
        this.sizer.clear();
      });
    }
  }
  ...
  _updateRenderedRange(skipSizeSync) {
    ...
    if (this._lastExcessHeight) {
      ...
      this._viewport.setRenderedContentOffset(
        this._lastRenderedContentOffset - lastExcessHeight
      );
    ...
    if (currentStartBuffer < this._minBufferPx && newRange.start !== 0) {
      ...
      const renderDataEnd =
        contentOffset +
        this.sizer.getSizeForRange(newRange.start, newRange.end);
...
class PblCdkVirtualScrollDirective extends PblNgridBaseVirtualScrollDirective {
  constructor(vScrollDynamic, vScrollNone, grid) {
    ...
    if (vScrollDynamic !== null && vScrollNone !== null) {
      if (typeof ngDevMode === 'undefined' || ngDevMode) {
        throw new Error(
          `Invalid vScroll instruction, only one value is allow.`
        );
      }
    }
  }
   ...
   */
  get vScrollDynamic() {
    return this._vScrollDynamic;
  }
  set vScrollDynamic(value) {
    this._vScrollDynamic = coerceNumberProperty(value);
  }
  ngOnInit() {
    switch (this.type) {
      case 'vScrollDynamic':
        ...
        this._scrollStrategy = new PblNgridDynamicVirtualScrollStrategy(
          this._vScrollDynamic,
          this._minBufferPx,
          this._maxBufferPx
        );
        break;
...
/** @nocollapse */ PblCdkVirtualScrollDirective.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblCdkVirtualScrollDirective,
  deps: [
    { token: 'vScrollDynamic', attribute: true },
    { token: 'vScrollNone', attribute: true },
    { token: PblNgridComponent },
  ],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblCdkVirtualScrollDirective.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblCdkVirtualScrollDirective,
...
class PblNgridScrolling {
  constructor(table, pluginCtrl, zone) {
     ...
     */
    this.scrolling = new EventEmitter();
    pluginCtrl.onInit().subscribe(() => {
      const { viewport } = table;
      if (viewport) {
        viewport.scrolling.subscribe((isScrolling) =>
          zone.run(() => this.scrolling.next(isScrolling))
        );
      }
    });
  }
}
/** @nocollapse */ PblNgridScrolling.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridScrolling,
  deps: [
    { token: PblNgridComponent },
    { token: PblNgridPluginController },
    { token: i0.NgZone },
  ],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridScrolling.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridScrolling,
  selector: 'pbl-ngrid[scrolling]',
  outputs: { scrolling: 'scrolling' },
  ngImport: i0,
});
i0.ɵɵngDeclareClassMetadata({
  minVersion: '12.0.0',
    ...
    if (this.dirty) {
      ...
      if (!this.differ && value) {
        try {
          ...
          if (typeof ngDevMode === 'undefined' || ngDevMode) {
            throw new Error(
              `Cannot find a differ supporting object '${value}. hideColumns only supports binding to Iterables such as Arrays.`
            );
          }
          return;
        }
...
/** @nocollapse */ PblNgridHideColumns.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridHideColumns,
  deps: [{ token: PblNgridPluginController }, { token: i0.IterableDiffers }],
  target: i0.ɵɵFactoryTarget.Directive,
});
/** @nocollapse */ PblNgridHideColumns.ɵdir = i0.ɵɵngDeclareDirective({
  minVersion: '14.0.0',
  version: '14.2.4',
  type: PblNgridHideColumns,
  selector: 'pbl-ngrid[hideColumns]',
  inputs: { hideColumns: 'hideColumns' },
  ngImport: i0,
});
i0.ɵɵngDeclareClassMetadata({
  minVersion: '12.0.0',
  ...
  ctorParameters: function () {
    return [{ type: PblNgridPluginController }, { type: i0.IterableDiffers }];
  },
  propDecorators: {
    hideColumns: [
      {
...
class PblCdkAutoSizeVirtualScrollDirective extends PblNgridBaseVirtualScrollDirective {
   ...
   */
  get vScrollAuto() {
    return this._vScrollAuto;
  }
  set vScrollAuto(value) {
    this._vScrollAuto = coerceNumberProperty(value);
  }
  ngOnInit() {
    if (!this._vScrollAuto) {
      this._vScrollAuto = this.grid.findInitialRowHeight() || 48;
    }
    this._scrollStrategy = new PblNgridAutoSizeVirtualScrollStrategy(
      this._minBufferPx,
      this._maxBufferPx,
      new PblNgridItemSizeAverager(this._vScrollAuto)
    );
  }
  ngOnChanges() {
    this._scrollStrategy?.updateBufferSize(
      this._minBufferPx,
      this._maxBufferPx
    );
  }
}
/** @nocollapse */ PblCdkAutoSizeVirtualScrollDirective.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblCdkAutoSizeVirtualScrollDirective,
    deps: [{ token: PblNgridComponent }],
    target: i0.ɵɵFactoryTarget.Directive,
  });
/** @nocollapse */ PblCdkAutoSizeVirtualScrollDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblCdkAutoSizeVirtualScrollDirective,
...
class PblCdkFixedSizedVirtualScrollDirective extends PblNgridBaseVirtualScrollDirective {
   ...
   */
  get vScrollFixed() {
    return this._vScrollFixed;
  }
  set vScrollFixed(value) {
    this._vScrollFixed = coerceNumberProperty(value);
  }
  ngOnInit() {
    if (!this._vScrollFixed) {
      this.vScrollFixed = this.grid.findInitialRowHeight() || 48;
    }
    this._scrollStrategy = new PblNgridFixedSizeVirtualScrollStrategy(
      this._vScrollFixed,
      this._minBufferPx,
      this._maxBufferPx
    );
...
/** @nocollapse */ PblCdkFixedSizedVirtualScrollDirective.ɵfac =
  i0.ɵɵngDeclareFactory({
    minVersion: '12.0.0',
    version: '14.2.4',
    ngImport: i0,
    type: PblCdkFixedSizedVirtualScrollDirective,
    deps: [{ token: PblNgridComponent }],
    target: i0.ɵɵFactoryTarget.Directive,
  });
/** @nocollapse */ PblCdkFixedSizedVirtualScrollDirective.ɵdir =
  i0.ɵɵngDeclareDirective({
    minVersion: '14.0.0',
    version: '14.2.4',
    type: PblCdkFixedSizedVirtualScrollDirective,
...
const COMMON_TABLE_TEMPLATE_INIT = new InjectionToken(
...
class PblNgridModule {
  ...
  static loadCommonTemplates(ngRef, component, options) {
    ...
    const cmpRef = ngRef.componentFactoryResolver
...
/** @nocollapse */ PblNgridModule.ɵfac = i0.ɵɵngDeclareFactory({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridModule,
  deps: [
    { token: i0.NgModuleRef },
    { token: PblNgridRegistryService },
    { token: COMMON_TABLE_TEMPLATE_INIT, optional: true, self: true },
  ],
  target: i0.ɵɵFactoryTarget.NgModule,
});
/** @nocollapse */ PblNgridModule.ɵmod = i0.ɵɵngDeclareNgModule({
  minVersion: '14.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridModule,
  ...
  imports: [CommonModule, ScrollingModule, ScrollingModule$1, CdkTableModule],
  exports: [
    PblNgridRowDef,
    PblNgridRowOverride,
    PblNgridRowComponent,
...
/** @nocollapse */ PblNgridModule.ɵinj = i0.ɵɵngDeclareInjector({
  minVersion: '12.0.0',
  version: '14.2.4',
  ngImport: i0,
  type: PblNgridModule,
...
export {
  ...
  PblColumnGroup,
  PblMetaColumn,
  PblNgridAutoSizeVirtualScrollStrategy,
  ...
  PblNgridDynamicVirtualScrollStrategy,
  PblNgridEditorCellDefDirective,
  PblNgridFixedSizeVirtualScrollStrategy,
  PblNgridFooterCellComponent,
  PblNgridFooterCellDefDirective,
  PblNgridHeaderCellComponent,
  PblNgridHeaderCellDefDirective,
...
//# sourceMappingURL=pebula-ngrid.mjs.map
